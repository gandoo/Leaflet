...
L.Map = L.Evented.extend({
	...
	_findEventTarget: function (srcElement) {
		var target = this._targets[L.stamp(srcElement)];
		if (!target && srcElement !== this._container) {
			return this._findEventTarget(srcElement.parentNode);
		}
		return target;
	},
